        ...
        while($row = mysqli_fetch_assoc($sql)){
            ...
            <div class="card">
                ...
                <div class="cardFooter">
                    <div class="">
                        <a href="register.php?event=post&get='.$row['news_id'].'" class="btn btn-primary like">Edit</a>
                        <a href="register.php?event=post&delete='.$row['news_id'].'"class="btn btn-danger dislike">Delete</a>
                    </div>
                    <div class="">
